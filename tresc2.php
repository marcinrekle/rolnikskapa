<?php
include("polacz.php");
$ile=mysql_num_rows(mysql_query("SELECT ID FROM news2011"));
...
echo "<div id=\"wyd\">\n<img class=\"wyd_img\" src=\"$news[6]\" name=\"obrazek\"/>
...
$zapytanie=mysql_query("SELECT * FROM news2011 WHERE id<$ile ORDER by id desc limit 5");
